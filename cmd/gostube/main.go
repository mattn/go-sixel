...
func play(ctx context.Context, videoURL, audioURL string, width, height int, fps, offset float64, withAudio bool, keys <-chan float64) (float64, error) {
	...
	cmd := ffmpegCommand(pctx, videoURL, audioURL, width, height, fps, offset, withAudio)
	if withAudio {
...
func ffmpegCommand(ctx context.Context, videoURL, audioURL string, width, height int, fps, offset float64, withAudio bool) *exec.Cmd {
